    ...
    const doSumbit = (e) =>{
      ...
      var newFormObj  = {
        ...
        data: {
          ...
          uid: this.state.uid,
          infoKr: this.state.infoKr,
          infoEn: this.state.infoEn,
          infoChn: this.state.infoChn,
          tagKr: this.state.tagKr,
          tagEn: this.state.tagEn,
          tagChn: this.state.tagChn,
          videoLink: this.state.videoLink,
          fileTemp: this.state.file,
          fileThumbTemp: this.state.fileThumb,
          fileIconTemp: this.state.fileIcon,
          fileVideoTemp: this.state.fileVideo,
        },
      };

      axios.post(`${cp.server_ip}/api/robot`, newFormObj)
        .then(res => {
            if (res.data.err) {
