                          ...
                          <div className="table-container">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.AddComma(this.state.weekAmount)} <br/> ({this.state.weekCount}) </td>
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.state.weekRewordAmount.userPik !== 0 ? this.AddComma(this.state.weekRewordAmount.userPik) : '-'} <br/> {this.state.weekRewordAmount.userPik !== 0 ? '(' + (this.state.weekRewordCount.userPik) + ')' : '' }</td>
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.state.weekRewordAmount.voteLucky !== 0 ? this.AddComma(this.state.weekRewordAmount.voteLucky) : '-'} <br/> {this.state.weekRewordAmount.voteLucky !== 0 ? '(' + (this.state.weekRewordCount.voteLucky) + ')' : '' }</td>
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.state.weekRewordAmount.userWinRandom !== 0 ? this.AddComma(this.state.weekRewordAmount.userWinRandom) : '-'} <br/> {this.state.weekRewordAmount.userWinRandom !== 0 ? '(' + (this.state.weekRewordCount.userWinRandom) + ')' : '' }</td>            
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.state.weekRewordAmount.dayWinRandom !== 0 ? this.AddComma(this.state.weekRewordAmount.dayWinRandom) : '-'} <br/> {this.state.weekRewordAmount.dayWinRandom !== 0 ? '(' + (this.state.weekRewordCount.dayWinRandom) + ')' : '' }</td>
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.state.weekRewordAmount.dayVoteRandom !== 0 ? this.AddComma(this.state.weekRewordAmount.dayVoteRandom) : '-'} <br/> {this.state.weekRewordAmount.dayVoteRandom !== 0 ? '(' + (this.state.weekRewordCount.dayVoteRandom) + ')' : '' }</td>
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.state.weekRewordAmount.weekWinRandom !== 0 ? this.AddComma(this.state.weekRewordAmount.weekWinRandom) : '-'} <br/> {this.state.weekRewordAmount.weekWinRandom !== 0 ? '(' + (this.state.weekRewordCount.weekWinRandom) + ')' : '' }</td>
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.state.weekRewordAmount.weekVoteRandom !== 0 ? this.AddComma(this.state.weekRewordAmount.weekVoteRandom) : '-'} <br/> {this.state.weekRewordAmount.weekVoteRandom !== 0 ? '(' + (this.state.weekRewordCount.weekVoteRandom) + ')' : '' }</td>
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.state.weekRewordAmount.weekRank !== 0 ? this.AddComma(this.state.weekRewordAmount.weekRank) : '-'} <br/> {this.state.weekRewordAmount.weekRank !== 0 ? '(' + (this.state.weekRewordCount.weekRank) + ')' : '' }</td>
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.state.weekRewordAmount.monthRank !== 0 ? this.AddComma(this.state.weekRewordAmount.monthRank) : '-'} <br/> {this.state.weekRewordAmount.monthRank !== 0 ? '(' + (this.state.weekRewordCount.monthRank) + ')' : '' }</td>
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.state.weekRewordAmount.lotteryOpen !== 0 ? this.AddComma(this.state.weekRewordAmount.lotteryOpen) : '-'} <br/> {this.state.weekRewordAmount.lotteryOpen !== 0 ? '(' + (this.state.weekRewordCount.lotteryOpen) + ')' : '' }</td>
                                    <td style={Object.assign({}, style.Config.w1, style.Config.wordCenter, style.Config.wordBlod)} >{this.state.weekRewordAmount.lotteryRecommender !== 0 ? this.AddComma(this.state.weekRewordAmount.lotteryRecommender) : '-'} <br/> {this.state.weekRewordAmount.lotteryRecommender !== 0 ? '(' + (this.state.weekRewordCount.userPik) + ')' : '' }</td> 
                                </tr>
                              </tbody>
                            </Table>
                          </div>
